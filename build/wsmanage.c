...
/* Q'Nial header files */
#include "coreif_p.h"        /* for error_env */
#include "wsmanage.h"
#include "qniallim.h"
#include "lib_main.h"
#include "absmach.h"
...
#include "mainlp.h"          /* for exit_cover and current_env */
...
/* routine to load a workspace. The flag user indicates whether this is a
   user request called from mainlp.c or a load of the clearws or continue ws
   from lib_main.c */
...
#define FILESEPARATOR '\\'
#else
#error define FILESEPARATOR for this operating system
#endif
...
/* routine that implements the primitive save.
   The actual save is done in mainlp.c after the longjmp. 
*/
...
/* routine to implement the primitive load.
   The actual load is done in mainlp.c after the longjmp. 
*/
