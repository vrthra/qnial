...
#define MATHLIB
#define CLIB                 /* required for scan.h */
#define STDLIB
#define STLIB
#define IOLIB                /* required for fileio.h */
#define LIMITLIB
#define SJLIB
#include "sysincl.h"
...
/* MAJ doubts the following:
   The V4AT rule is that the stdfault is returned unless all the
   items are the same fault;
*/
