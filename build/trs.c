...
#include "messages.h"        /* for error msgs */
...
#endif
static void
radixsort(unsigned *integers, unsigned *new_arr,
          unsigned *inds, int n, int shift, int mask, int gradwsw);
static void radixsortupint(void);
static void radixgradeupint(void);

/*
   static void radixsortupreal(void);
...
/* radix sort with grade option */

static void
radixsort(unsigned integers[], unsigned new_arr[], unsigned inds[],
...
radixsortupint()
{
  ...
  radixsort(zp, newzp, zp, t, 0, 0x7ff, false);
  radixsort(newzp, zp, zp, t, 11, 0x7ff, false);
  radixsort(zp, newzp, zp, t, 22, 0x3ff, false);
  i = 0;
...
radixgradeupint()
{
  ...
  radixsort(zp, newzp, indp, t, 0, 0x7ff, true);
  radixsort(zp, indp, newzp, t, 11, 0x7ff, true);
  radixsort(zp, newzp, indp, t, 22, 0x3ff, true);
  i = 0;
